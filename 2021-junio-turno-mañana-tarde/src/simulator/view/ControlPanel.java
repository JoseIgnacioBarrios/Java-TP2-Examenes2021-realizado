...
public class ControlPanel extends JPanel implements SimulatorObserver{
	...
	private JButton chooseFileButton,chooseForceButton,startButton,stopButton,exitButton,totalforce;
	private JSpinner stepsSpinner;
	private JFileChooser fileChooser;
	private JTextField deltaTimeField;
	private ForceLawDialog forceDialog;
	private MainWindow mainWindow;
	private totalForce totalforceJdialog;
	String archivo;
	/**
	...
	private void initGUI() {
		...
		totalforceJdialog= new totalForce(mainWindow, _ctrl);
		totalforce=new JButton();
		totalforce.setText("TotalForce");
		totalforce.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				if(totalforceJdialog.open()==1) {
